...
export default function InvestmentsScreen() {
  ...
  const industryDistribution = investments.reduce((acc, inv) => {
    acc[inv.industry] = (acc[inv.industry] || 0) + inv.investmentAmount;
    return acc;
  }, {} as Record<string, number>);

  const pieData = Object.entries(industryDistribution).map(
    ([industry, amount]) => ({
      name: industry,
      value: amount,
    })
  ...
  const getROI = (investment: Investment) => {
    const currentValue =
      (investment.currentValuation * investment.equityStake) / 100;
    return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          >
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  ${(currentPortfolioValue / 1000).toFixed(0)}K
                </div>
          ...
          >
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-green-600">
                  +{getROI(investments[2]).toFixed(1)}% ROI
                </p>
              </CardContent>
            </Card>
          </motion.div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        <Avatar className="h-12 w-12">
                          <AvatarImage
                            src={investment.founderAvatar || "/placeholder.svg"}
                          />
                          <AvatarFallback>
                            {investment.founderName.charAt(0)}
                          </AvatarFallback>
                        </Avatar>
                        <div>
                      ...
                      <div className="text-right space-y-1">
                        <div className="flex items-center gap-4">
                          <div>
                            ...
                            <div className="font-semibold">
                              ${(investment.investmentAmount / 1000).toFixed(0)}
                              K
                            </div>
                          </div>
                          <div>
                        ...
                        <div className="flex items-center gap-2">
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              router.push(`/messages?project=${investment.id}`)
                            }
                          >
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              <DropdownMenuItem
                                onClick={() =>
                                  router.push(`/projects/${investment.id}`)
                                }
                              >
                    ...
                    {investment.notes && (
                      <div className="mt-3 p-3 bg-muted/30 rounded-lg">
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                          Last updated: {investment.lastUpdate}
                        </p>
                      </div>
                    )}
                  </motion.div>
