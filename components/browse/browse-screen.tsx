...
export default function BrowseScreen() {
  ...
  // Sidebar and top navigation are handled by AppLayout; keep screen focused on content
  ...
  // no-op: App-level layout handles responsive sidebar behavior
      ...
      <div ref={containerRef} className="min-h-screen overflow-hidden relative">
              ...
              >
                ...
                <div className="absolute inset-0">
                  {currentProject.images.length > 0 ? (
                    <img
                      src={
                        currentProject.images.find((img) => img.isPrimary)
                          ?.url ||
                  ...
                  <div className="max-w-2xl">
                    ...
                    <div className="flex items-center gap-3 mb-4">
                      <Avatar className="h-10 w-10 border-2 border-white/50">
                        <AvatarImage
                          src={
                            currentProject.inventor.profileImage ||
        ...
        {currentIndex === 0 && (
          ...
          >
            ...
            <p className="text-sm drop-shadow-lg font-medium">
