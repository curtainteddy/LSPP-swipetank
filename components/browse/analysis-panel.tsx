            ...
            <div className="p-6 space-y-6 pb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="text-center p-6 bg-white/10 rounded-xl border border-white/20">
                    ...
                    <Badge
                      className={`text-sm px-4 py-2 ${
                        analysisData.summary?.investmentRecommendation?.includes(
                          "Strong"
                        )
                  ...
                  <div className="p-6 bg-white/10 rounded-xl border border-white/20">
                    ...
                    <div className="space-y-2">
                      {analysisData.summary?.keyHighlights
                        ?.slice(0, 2)
                        .map((highlight, idx) => (
              ...
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                  <div className="p-4 bg-white/5 rounded-xl">
                    ...
                    <p className="text-lg font-semibold text-white">
                      {analysisData.marketAnalysis?.marketSize}
                    </p>
                  </div>
                  <div className="p-4 bg-white/5 rounded-xl">
                    <p className="text-sm font-medium text-white/70 mb-1">
                    ...
                    <p className="text-lg font-semibold text-green-400">
                      {analysisData.marketAnalysis?.growthRate}
                    </p>
                  </div>
                </div>
                ...
                <div className="p-4 bg-white/5 rounded-xl">
                  ...
                  <p className="text-sm leading-relaxed text-white/90">
                    {analysisData.marketAnalysis?.targetAudience}
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6">
                ...
                <div className="grid grid-cols-3 gap-4 mb-6">
                  <div className="text-center p-4 bg-white/5 rounded-xl">
                    ...
                    <p className="font-semibold text-white">
                      {
                        analysisData.financialProjection?.revenueProjection
                          ?.year1
                      }
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 bg-white/5 rounded-xl">
                    ...
                    <p className="text-lg font-semibold text-green-400">
                      {analysisData.investmentMetrics?.expectedROI}
                    </p>
                  </div>
                  <div className="p-4 bg-white/5 rounded-xl">
                    <p className="text-sm font-medium text-white/70 mb-1">
                    ...
                    <p className="text-lg font-semibold text-white">
                      {analysisData.investmentMetrics?.timeToExit}
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6">
                  ...
                  <div className="p-4 bg-blue-500/20 border border-blue-400/30 rounded-xl">
                    ...
                    <p className="text-sm text-blue-100">
                      {analysisData.competitorAnalysis?.competitiveAdvantage}
                    </p>
                  </div>
                </div>
              )}
              ...
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <Badge
                    className={`ml-2 ${
                      analysisData.riskAssessment?.riskLevel === "Low"
                        ? "bg-green-500/80 text-white border-green-400/50"
                        : analysisData.riskAssessment?.riskLevel === "Medium"
                        ? "bg-yellow-500/80 text-white border-yellow-400/50"
                        : "bg-red-500/80 text-white border-red-400/50"
                    }`}
                  >
                ...
                <div className="space-y-4">
                  {analysisData.riskAssessment?.majorRisks
                    ?.slice(0, 3)
                    .map((risk, idx) => (
                      <div key={idx} className="p-4 bg-white/5 rounded-xl">
